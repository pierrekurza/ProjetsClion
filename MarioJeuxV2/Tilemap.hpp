...
// Accesseurs
    ...
    int getCharacterBeginX() const { return characterBeginX; }

    int getCharacterBeginY() const { return characterBeginY; }

    int getMapStartX() const { return mapStartX; }

    int getMapStartY() const { return mapStartY; }

    int getMapEndX() const { return mapEndX; }

    int getMapEndY() const { return mapEndY; }

    int getTile(int y, int x) const { return tile1[y][x]; }

    int getMonstersNumber() const { return monstersNumber; }


    // Setteurs
    void setMapStartX(int v) { mapStartX = v; }

    void setMapStartY(int v) { mapStartY = v; }

    void setTile(int y, int x, int v) { tile1[y][x] = v; }

    void setLevel(int v) { level = v; }

    void setMonstersNumber(int v) { monstersNumber = v; }
